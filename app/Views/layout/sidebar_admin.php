<div id="sidebar" class="sidebar responsive ace-save-state">
    ...
    <ul class="nav nav-list">
        ...
        <li class="<?= in_array(uri_string(), ['admin/master/user', 'admin/master/cars']) ? 'active open' : ''; ?>">
            ...
            <ul class="submenu">
                <li class="<?= uri_string() == 'admin/master/user' ? 'active' : ''; ?>">
                ...
                <li class="<?= uri_string() == 'admin/master/cars' ? 'active' : ''; ?>">
